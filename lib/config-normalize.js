...
export const DEFAULT_HELP_CFG = {
  ...
  style: {
    ...
    descColor: '#334155',
    footerColor: '#f8fafc',
    contBgColor: 'rgba(255, 255, 255, 0.16)',
    groupBgColor: 'linear-gradient(90deg, rgba(94, 234, 212, 0.18), rgba(255, 255, 255, 0.20))',
    rowBgColor1: 'rgba(248, 250, 252, 0.22)',
    rowBgColor2: 'rgba(241, 245, 249, 0.16)'
  }
};
