...
export const HELP_PAGE_WIDTH = 960;
/** 1.5× 足够清晰；3× 会出近万 KB 图，QQ 里缩得很小、字发糊 */
export const HELP_DEVICE_SCALE = 1.5;
...
export const HELP_SCREENSHOT_OPTS = {
  ...
  imgType: 'jpeg',
  quality: 82,
  imageWaitTimeout: 1200,
  fontWaitTimeout: 2500,
  selector: '.container',
  waitUntil: 'domcontentloaded'
};

export const HELP_FONT_FAMILY = "'XRK Help', 'Microsoft YaHei', 'PingFang SC', sans-serif";
...
body.xrk-help { min-height:100%; font-family:${HELP_FONT_FAMILY}; font-weight:400; -webkit-font-smoothing:antialiased; display:flex; justify-content:center; }
.container { ${bodyBg} min-height:720px; margin:0 auto; display:flex; flex-direction:column; }
...
export function writeHelpPage({
  ...
  const css = FileUtils.readFileSync(path.join(helpDir, 'help_template.css'))
