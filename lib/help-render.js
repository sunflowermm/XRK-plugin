...
export const HELP_FONT_FAMILY = "'PingFang SC', 'Microsoft YaHei', 'Noto Sans SC', sans-serif";
...
body.xrk-help { min-height:100%; font-family:${HELP_FONT_FAMILY}; -webkit-font-smoothing:antialiased; display:flex; justify-content:center; }
