...
export const helpSystemSchemas = [
  ...
  num('help_system_cfg.columnCount', '列数', { min: 1, max: 6 }),
  num('help_system_cfg.colWidth', '列宽', { min: 100 }),
  inp('help_system_cfg.theme', '主题'),
  tags('help_system_cfg.themeExclude', '排除主题'),
  sw('help_system_cfg.bgBlur', '背景模糊'),
  objForm('help_system_cfg.style', '样式', [
    inp('fontColor', '字体颜色'),
    inp('descColor', '描述颜色'),
    inp('contBgColor', '内容背景色'),
    num('contBgBlur', '内容背景模糊', { min: 0 }),
    inp('headerBgColor', '头部背景色'),
    inp('rowBgColor1', '行背景色1'),
    inp('rowBgColor2', '行背景色2'),
  ]),
